...
Selection AdminMenu::showMenu()
{
	...
	std::cout << (int)Selection::ADD_AUTHOR << " - Добавить исполнителя" << std::endl;
	std::cout << (int)Selection::ADD_ALBUM  << " - Добавить альбом" << std::endl;
	std::cout << (int)Selection::ADD_SONG   << " - Добавить песню" << std::endl;
